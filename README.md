...
- **How to use:** Click the chat icon on the left ribbon or execute `Lumina: Open Chat` from the command palette.
...
- **How to use:** Click the chat icon on the left ribbon to open the side panel, and switch to the Smart Discovery tab at the top.
</details>
