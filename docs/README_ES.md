...
| **🚀 Modo de Agente Inteligente** | El LLM planifica y ejecuta tareas complejas como búsqueda, creación, modificación, eliminación/movimiento de notas y ejecución de código en un sandbox usando 21 herramientas MCP integradas. |
...
- **Descripción:** Cuando se activa, el LLM determina y organiza de forma autónoma 21 herramientas MCP integradas para realizar tareas. Puede completar operaciones complejas de varios pasos combinando la búsqueda, lectura y escritura de notas, recuperación RAG, ejecución de código en sandbox e integración de notas diarias.
